...
public final class Grille {
    ...
    public boolean estVictoireEnColonne(final int colonne, final Pion pion) {
        ...
        for (int i = 0; i < NB_LIGNES; i++) {
            casesConsecutives = (m_grille[i][colonne] == pion) ? casesConsecutives + 1 : 0;
    ...
    public boolean estVictoireEnLigne(final int ligne, final Pion pion) {
        ...
        for (int i = 0; i < NB_COLONNES; i++) {
            casesConsecutives = (m_grille[ligne][i] == pion) ? casesConsecutives + 1 : 0;
            if (casesConsecutives == 4) {
                return true;
            }
        }
    ...
    public boolean estVictoireEnDiagonale(final Pion pion) {
        for (int j = 0; j < NB_LIGNES; j++) {
            ...
            for (int i = 0; i < (NB_LIGNES - j); i++) {
                casesConsecutives = (m_grille[j + i][i] == pion) ? casesConsecutives + 1 : 0;
                if (casesConsecutives == 4) {
                    return true;
                }
            }
        ...
        for (int j = 0; j < NB_LIGNES; j++) {
            int casesConsecutives = 0;
            for (int i = 0; i < (NB_LIGNES - j); i++) {
                casesConsecutives = (m_grille[i][i + j + 1] == pion) ? casesConsecutives + 1 : 0;
                if (casesConsecutives == 4) {
                    return true;
                }
            }
        ...
        for (int j = 0; j < NB_LIGNES; j++) {
            int casesConsecutives = 0;
            for (int i = 0; i < (NB_LIGNES - j); i++) {
                casesConsecutives = (m_grille[NB_LIGNES - 1 - i][i + j] == pion) ? casesConsecutives + 1 : 0;
                if (casesConsecutives == 4) {
                    return true;
                }
            }
        ...
        for (int j = 0; j < NB_LIGNES; j++) {
            int casesConsecutives = 0;
            for (int i = 0; i < (NB_LIGNES - j); i++) {
                casesConsecutives = (m_grille[NB_LIGNES - 1 - i - j][i] == pion) ? casesConsecutives + 1 : 0;
                if (casesConsecutives == 4) {
                    return true;
                }
            }
